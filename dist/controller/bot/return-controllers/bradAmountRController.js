...
const bradAmountRController = function (ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        const messages = new messages_1.default(ctx.session, ctx.isTomorrow);
        yield (0, bot_1.setOrderSession)(ctx, ctx.userId, ["amount", "breadType"], undefined);
...
bradAmountRController.type = controllerTypes_1.default.RETURN;
bradAmountRController.occasion = session_1.SessionStates.ENTERING_BREAD_AMOUNT;
exports.default = bradAmountRController;
