...
const unitRController = function (ctx) {
    return __awaiter(this, void 0, void 0, function* () {
        const messages = new messages_1.default(ctx.session, ctx.isTomorrow);
        yield (0, bot_1.setOrderSession)(ctx, ctx.userId, ["unit", "floor"], undefined);
...
unitRController.type = controllerTypes_1.default.RETURN;
unitRController.occasion = session_1.SessionStates.ENTERING_UNIT;
exports.default = unitRController;
